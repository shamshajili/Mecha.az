    ...
    <Spotlight className="w-full" fill="hsl(var(--primary))"> 
      <section className="relative bg-black text-white py-24 px-6">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[450px] h-[450px] bg-green-400 opacity-30 rounded-full blur-[150px] absolute bottom-[1300px]"></div> 
        </div>
        ...
        <section className="py-25 bg-black text-white px-6 text-center">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-400 text-lg mb-4">
              ...
              <span className="block text-gray-400 mt-2">automated systems.</span>
            </p>
          </div>
        </section>
